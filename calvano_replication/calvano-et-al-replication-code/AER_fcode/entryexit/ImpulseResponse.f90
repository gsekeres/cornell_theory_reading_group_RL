...
!
    ...
    DO iPrice = 1, numPrices
        ...
        selProfits(iPrice) = PI(computeActionNumber(pPrime),iAgent)
        !
    END DO
...
!
    ...
    ! Beginning execution
    !
    p = RESHAPE(convertNumberBase(InitialState-1,numPrices,numAgents), (/ numAgents /))
    ...
    VisitedPrices = 0.d0
    VisitedProfits = 0.d0
    p = RESHAPE(indexShockState, (/ numAgents /) )
