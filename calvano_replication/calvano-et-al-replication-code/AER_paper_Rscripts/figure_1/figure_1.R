# &&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
# Figure 1
# Average profit gain Delta for a grid of values of alpha and beta
# &&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
...
pdf(file = "figure_1.pdf", width = 6, height = 4, paper = 'special')
levelplot(avgPrGain ~ beta*alpha, data = p,
