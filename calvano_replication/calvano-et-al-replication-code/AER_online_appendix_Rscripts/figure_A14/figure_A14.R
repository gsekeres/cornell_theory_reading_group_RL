# &&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
# Figure A14
# Average Impulse Response to a BR deviation with 3 agents
# &&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
...
data = read.csv("A_irToBR.txt", header = TRUE, sep = "")
...
op = par(cex = 0.8)
legend(x = 9.6, y = 2,
       legend = c("Deviating agent", "Nondeviating agents", "Nash price", "Monopoly price", 
                  "Long run price"), 
